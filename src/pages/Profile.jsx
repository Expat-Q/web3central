...
import {
    ...
    ExternalLink, Trash2, Edit3, Save, X, Twitter, FolderGit2, Settings
} from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 gap-4 mb-10">
                    {[
                        ...
                        { label: 'Diamond XP', value: user.diamonds || 0, icon: <Zap size={18} />, color: 'amber' },
                        { label: 'Total XP', value: user.totalXP || 0, icon: <TrendingUp size={18} />, color: 'indigo' }
                    ].map((stat, i) => (
                        <motion.div
                            key={i}
